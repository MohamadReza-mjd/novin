...
('click', () =>{
    ...
    document.querySelector('.container').style.cssText = 'background: linear-gradient(rgba(0, 0, 0, .5),rgba(0, 0, 0, .2)), url(images/TOYOTA.jpg) center no-repeat; background-size: cover';
});
